...
a persistence unit "backend-upsplayPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "backend-upsplay/pom.xml":
...
artifact ("backend-upsplay.war") is already built. You can build
